...
namespace SendByMailServerExtension
{
    /// <summary>
    /// Задаёт описание расширения для WebClient, которое задано в текущей сборке
    /// </summary>
    public class SendByMailServerExtension : WebClientExtension
    {
        /// <summary>
        /// Создаёт новый экземпляр <see cref="SendByMailServerExtension" />
        /// </summary>
        /// <param name="serviceProvider">Сервис-провайдер</param>
        public SendByMailServerExtension(IServiceProvider serviceProvider)
        ...
        {
            get { return Assembly.GetAssembly(typeof(SendByMailServerExtension)).GetName().Name; }
        }
